...
func deleteHandler(w http.ResponseWriter, r *http.Request) {
    ...
    if err := deletePost(id, username); err != nil {
        http.Error(w, "Failed to delete post from GCS or Elasticsearch", http.StatusInternalServerError)
        fmt.Printf("Failed to delete post from GCS or Elasticsearch %v\n", err)
        return
    }
